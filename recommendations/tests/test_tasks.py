...
class GHUserStarredRepositories(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_authorized_user = GHUser(username=cls.test_authorized_username,
                                      github_username=cls.test_authorized_github_username)
        test_authorized_user.save()

    def test_github_call(self):
        cltask_user_starred_repositories(self.test_authorized_username,
                                         self.test_authorized_github_username)
