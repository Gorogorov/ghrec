...
urlpatterns = [
    ...
    path('api/user/groups/<str:group_name>/recommendations/compute/', recommendations.recommendations_compute),
    path('api/user/groups/<str:group_name>/recommendations/', recommendations.recommendations_list),
]
